...
You're going to use the [Quix Streams](../reference/client-library-intro.md) library to push data into Quix Platform. This is just one of [many ways](../develop/integrate-data/index.md) to get your data into Quix. You could for example simply log into Quix and use one of our already available [connectors](../connectors/index.md), but where's the fun in that!
