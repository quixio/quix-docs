...
Note, you obtain your [Streaming Token (SDK Token)](../../quix-cloud/applications/authentication/streaming-token.md) once you have created an environment, as the token is specifically for use with that environment.
