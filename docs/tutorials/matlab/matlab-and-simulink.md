...
### Deploying a MATLAB function
 ...
 1. Sign in to your environment in [Quix](https://portal.cloud.quix.io/){target=_blank}.
...
### Deploying a Simulink model
 ...
 1. Sign in to the environment in [Quix](https://portal.cloud.quix.io/){target=_blank}.
