...
You'll need to [create any secret project variables](../deployments/project-variables.md) the project requires, for example, for external services such as InfluxDB Cloud.
