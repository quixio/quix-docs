...
2. The exception to this is the case of [project variables](../deployments/project-variables.md). When project variables are created, if they are referenced in `quix.yaml`, you will need to perform manual synchronization. You are prompted if this is required.
