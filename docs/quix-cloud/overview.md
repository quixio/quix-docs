---
title: Quix Cloud
description: Quix Cloud is a managed platform to deploy, collaborate on, and observe real-time pipelines for your test data — scale and monitor without the DevOps overhead.
---
