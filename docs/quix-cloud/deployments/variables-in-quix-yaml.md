...
**`inputType:` binding** declares an application variable that resolves into a container environment variable at deploy time — the value never lands in `quix.yaml`.
