...
Your data processing pipeline typically consists of multiple applications working together. Each application represents the implementation of a source, transform, or destination. You develop your application in an environment (a branch in your project), but you can later merge these changes with other branches as required. You can write and test your code directly in the browser using [dev sessions](./dev-sessions/overview.md), which provide a cloud-based IDE with access to your pipeline's data and infrastructure.
