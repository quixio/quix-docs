...
Check out our [Tutorials](../../quix-streams/tutorials/README.md) to get started. 
...
Look at [InfluxDB3Sink](../../quix-streams/api-reference/sinks.md#influxdb3sink) as an example. 
