...
* [`quixstreams.sources.base.Source`](../../../quix-streams/api-reference/sources.md#source): A subclass of `BaseSource` that implements some helpful methods for writing sources. We recommend subclassing `Source` instead of `BaseSource`.
* [`quixstreams.sources.base.BaseSource`](../../../quix-streams/api-reference/sources.md#basesource): This is the base class for all other sources. It defines the must-have methods.
...
For more information, see [`quixstreams.sources.base.Source`](../../../quix-streams/api-reference/sources.md#source) docstrings.
...
For more information, see [`quixstreams.sources.base.BaseSource`](../../../quix-streams/api-reference/sources.md#basesource) docstrings.
