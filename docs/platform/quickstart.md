...
You're going to use the [Quix Streams](../client-library-intro.md) library to push data into Quix Platform. This is just one of [many ways](../platform/connect-to-quix.md) to get your data into Quix. You could for example simply log into Quix and use one of our already available [connectors](../platform/connectors/index.md), but where's the fun in that!
...
1. Open up a terminal on your laptop and create a new file `cpu_load.py`.
