...
2.  Streaming Writer API
	  - <https://writer-[YOUR_ORGANISATION_ID]-[YOUR_WORKSPACE_ID].platform.quix.io/index.html>
        
3.  Telemetry Query API

	  - <https://telemetry-query-[YOUR_ORGANISATION_ID]-[YOUR_WORKSPACE_ID].platform.quix.io/swagger/index.html>
