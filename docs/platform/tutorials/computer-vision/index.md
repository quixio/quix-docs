...
In this tutorial you learn about a real-time computer vision pipeline, using a [Quix template project](https://github.com/quixio/computer-vision-demo){target=_blank}. 
...
[See the deployed project running](https://app-demo-computervisiondemo-prod.deployments.quix.ai/){ .md-button .md-button--primary target=_blank}
