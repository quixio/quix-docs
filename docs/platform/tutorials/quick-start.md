...
Once the UI is built and deployed you can go ahead and click the ![open in new window icon](../images/general/open_in_new_window.png){width=20px} icon on the `Sentiment Demo UI` tile.
