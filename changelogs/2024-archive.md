# Quix product 2024 changelog archive

This is the changelog for 2024. Changelogs for previous years can be found [here](#changelog-archives).

## 2024-11-linked-projects | 25 NOVEMBER 2024

`NEW FEATURES`

- Linked projects: Share real-time data across projects by linking topics. Linked projects enable seamless data stream connections, fostering cross-team collaboration and efficient data sharing. The new Project Pipeline view provides a clear graphical representation of these connections, simplifying the understanding of data flows between projects. This feature requires updating the Quix Streams version to 3.1.1 or higher for any app using a linked topic.
...
## 2024-10-scratchpads | 30 OCTOBER 2024

`NEW FEATURES`

- Scratchpads: Enables shared topics between environments, setting resources only in the affected parts of the pipeline and allowing code modifications to be safely merged back into Production. This feature requires updating the Quix Streams version to 3.1.1 or higher for any app using a scratchpad topic.
...
Enterprise changes
- Private and Public connectors and templates are now separated.
- Added SSH support to Private connectors and templates

## 2024-10-IDE | 16 OCTOBER 2024
...
## 2024-10-audit-historical-logs | 08 OCTOBER 2024
